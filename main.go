...
func main() {
	remoteAPIURL := []string{
		"https://magicamerican.com/shower-glass-mirror-cleaner",
		"https://magicamerican.com/grout-cleaner-ceramic-porcelain",
		"https://magicamerican.com/stainless-cleaner-polish-aerosol",
		"https://magicamerican.com/splash-guard-large",
		"https://magicamerican.com/splash-guard-kit",
		"https://magicamerican.com/squeegee",
		"https://magicamerican.com/shower-hook",
		"https://magicamerican.com/drain-strainer",
		"https://magicamerican.com/tub-stopper",
		"https://magicamerican.com/bath-mat",
		"https://magicamerican.com/soap-dish",
		"https://magicamerican.com/shower-basket",
		"https://magicamerican.com/shower-safety-treads",
		"https://magicamerican.com/wall-guard-patch",
		"https://magicamerican.com/counter-appliance-gap-eraser",
		"https://magicamerican.com/tub-floor-peel-stick-caulk",
		"https://magicamerican.com/tub-wall-peel-stick-caulk-narrow",
		"https://magicamerican.com/tub-wall-peel-stick-caulk-wide",
		"https://magicamerican.com/grout-coating-pen",
	}
...
func extractPDFUrls(rawText string) []string {
	...
	requiredKeywords := []string{"magicamerican.com", "mwdownloads", "download"}
